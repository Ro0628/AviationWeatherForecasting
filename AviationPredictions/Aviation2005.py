...
# val["DATE"] = pd.to_datetime(test["DATE"])
...
# KDLS
# test_station = pd.read_csv(file_cleaned)
# test_station["DATE"] = pd.to_datetime(test_station["DATE"])
# test_station = test_station[(test_station['DATE'] >= '2005-01-01')]
# test_station = test_station[(test_station['STATION_CODES'] == 17)]
# test_station.to_csv("/Users/ronaldajohnson/PycharmProjects/AviationWeatherForecasting/data/WeatherData_TestingStation.csv",index=False)
